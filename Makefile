...
trash:
	@protoc -I ${PROTO_PATH} ${PROTO_PATH}/**/*.proto --plugin=node_modules/.bin/protoc-gen-ts_proto --ts_proto_out=${TS_GEN_PATH} --ts_proto_opt=outputServices=grpc-web --ts_proto_opt=esModuleInterop=true