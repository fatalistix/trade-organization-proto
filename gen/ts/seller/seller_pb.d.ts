...
export class Seller extends jspb.Message {
  ...
  getPlaceOfWorkType(): string;
  setPlaceOfWorkType(value: string): Seller;

  getTradingPointId(): number;
  setTradingPointId(value: number): Seller;

  getTradingPointType(): string;
  setTradingPointType(value: string): Seller;
...
export class RegisterRequest extends jspb.Message {
  ...
  getPlaceOfWorkType(): string;
  setPlaceOfWorkType(value: string): RegisterRequest;

  getTradingPointId(): number;
  setTradingPointId(value: number): RegisterRequest;

  getTradingPointType(): string;
  setTradingPointType(value: string): RegisterRequest;
...
export class ListByTradingPointRequest extends jspb.Message {
  ...
  getTradingPointType(): string;
  setTradingPointType(value: string): ListByTradingPointRequest;
