...
var file_order_order_proto_depIdxs = []int32{
	...
	1,  // 7: order.ListResponse.orders:type_name -> order.Order
	1,  // 8: order.OrderResponse.order:type_name -> order.Order
	1,  // 9: order.UpdateRequest.order:type_name -> order.Order
	3,  // 10: order.OrderService.Create:input_type -> order.CreateRequest
	5,  // 11: order.OrderService.List:input_type -> order.ListRequest
	7,  // 12: order.OrderService.Order:input_type -> order.OrderRequest
	9,  // 13: order.OrderService.Update:input_type -> order.UpdateRequest
	4,  // 14: order.OrderService.Create:output_type -> order.CreateResponse
	6,  // 15: order.OrderService.List:output_type -> order.ListResponse
	8,  // 16: order.OrderService.Order:output_type -> order.OrderResponse
	10, // 17: order.OrderService.Update:output_type -> order.UpdateResponse
